    ...
    <div style={{minWidth:"1350px"}} className='mt-4'>
      <div className='d-flex justify-content-center text-capitalize py-5' style={{backgroundColor:"#001a33", gap:"150px"}}>
        <div style={{gap:"7px"}} className='d-flex flex-column'>
          ...
          <div className='text-light'>About amazon</div>
          <div className='text-light'>Careers</div>
          <div className='text-light'>divress Releases</div>
          <div className='text-light'>Amazon science</div>
        </div>
        ...
        <div style={{gap:"7px"}} className='d-flex flex-column'>
          ...
          <div className='text-light'>sell on amazon</div>
          <div className='text-light'>sell under amazon accelarator</div>
          <div className='text-light'>divrotect and build your brand</div>
          <div className='text-light'>amazon global selling</div>
          <div className='text-light'>sudivdivly to amazon</div>
          <div className='text-light'>become an affiliate</div>
          <div className='text-light'>fulfillment by amazon</div>
          <div className='text-light'>advertise your divroducts</div>
          <div className='text-light'>amazon divay on merchants</div>
        </div>
        ...
        <div style={{gap:"7px"}} className='d-flex flex-column'>
          ...
          <div className='text-light'>amazon app download</div>
      ...
      <div style={{borderTop:"1px solid gray", backgroundColor:"#001a33", gap:"150px"}} className='py-5 d-flex justify-content-center'>
        <div className='text-white'>amazon.in</div>
